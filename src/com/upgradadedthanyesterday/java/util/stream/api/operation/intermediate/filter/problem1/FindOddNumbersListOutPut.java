package com.upgradadedthanyesterday.java.util.stream.api.operation.intermediate.filter.problem1;
 ...
 */
public class FindOddNumbersListOutPut {
    public static void main(String[] args) {
        ...
        List<Integer> op = intStream.filter(FindOddNumbersListOutPut::isOdd).toList();
